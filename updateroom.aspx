<%@ Page Language="C#" AutoEventWireup="true" CodeFile="updateroom.aspx.cs" Inherits="updateroom" %>
...
<script type="text/javascript" src="js/coin-slider.min.js"></script>
 <script language="javascript" type="text/javascript">
   function view(id)
  {
   location.href='updateroom.aspx?id='+id;
  }
  function dele(id1)
  {
   location.href='updateroom.aspx?id1='+id1;
  }
  </script>
  <style type="text/css">
...
<body>
  ...
  <div class="header">
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          <li class="active"><a href="index.aspx"><span>Rooms</span></a></li>
  ...
  <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
   ...
   <h2 style="color:White;">Update Room</h2>
<br />
     <asp:TextBox ID="TextBox1" runat="server" Width="500px" Height="30px" placeholder="Block No" ValidationGroup="life"></asp:TextBox>
    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" ControlToValidate="TextBox1" ValidationGroup="life"></asp:RequiredFieldValidator>
     ...
     <asp:TextBox ID="TextBox2" runat="server" Width="500px" Height="30px" placeholder="Block Name" ValidationGroup="life"></asp:TextBox>
    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="*" ControlToValidate="TextBox2" ValidationGroup="life"></asp:RequiredFieldValidator>
     <asp:TextBox ID="TextBox3" runat="server" Width="500px" Height="30px" placeholder="Room No" ValidationGroup="life"></asp:TextBox>
