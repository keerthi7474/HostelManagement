...
<body>
  ...
  <div class="content">
   ...
   <h2 style="color:White;">Add Student Details</h2>
<br />
     <asp:TextBox ID="TextBox1" runat="server" Width="500px" Height="30px" placeholder="Student Name" ValidationGroup="life"></asp:TextBox>
    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" ControlToValidate="TextBox1" ValidationGroup="life"></asp:RequiredFieldValidator>
     ...
     <asp:TextBox ID="TextBox2" runat="server" Width="500px" Height="30px" placeholder="Roll No" ValidationGroup="life"></asp:TextBox>
    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="*" ControlToValidate="TextBox2" ValidationGroup="life"></asp:RequiredFieldValidator>
            ...
            <asp:DropDownList ID="DropDownList1" runat="server" Width="500px" Height="50px" ValidationGroup="life">
            <asp:ListItem Text="Select Department"></asp:ListItem>
             ...
             <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*" ControlToValidate="DropDownList1" ValidationGroup="life" InitialValue="Select Department"></asp:RequiredFieldValidator>
      <asp:DropDownList ID="DropDownList2" runat="server" Width="500px" Height="50px" ValidationGroup="life">
            <asp:ListItem Text="Select Semester"></asp:ListItem>
             ...
             <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="*" ControlToValidate="DropDownList2" ValidationGroup="life" InitialValue="Select Semester"></asp:RequiredFieldValidator>
 
     <asp:TextBox ID="TextBox3" runat="server" Width="500px" Height="70px" placeholder="Address" ValidationGroup="life" TextMode="MultiLine"></asp:TextBox>
    ...
    <asp:TextBox ID="TextBox4" runat="server" Width="500px" Height="30px" placeholder="Phoneno" ValidationGroup="life"></asp:TextBox>
    ...
    <asp:TextBox ID="TextBox5" runat="server" Width="500px" Height="30px" placeholder="Email ID" ValidationGroup="life"></asp:TextBox>
  ...
  <asp:TextBox ID="TextBox6" runat="server" Width="500px" Height="30px" placeholder="Block Name" ValidationGroup="life"></asp:TextBox>
    <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ErrorMessage="*" ControlToValidate="TextBox6" ValidationGroup="life"></asp:RequiredFieldValidator>
      <asp:TextBox ID="TextBox8" runat="server" Width="500px" Height="30px" placeholder="Admission Date" ValidationGroup="life"></asp:TextBox>
    <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ErrorMessage="*" ControlToValidate="TextBox8" ValidationGroup="life"></asp:RequiredFieldValidator>
