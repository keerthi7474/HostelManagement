<%@ Page Language="C#" AutoEventWireup="true" CodeFile="holidayslist.aspx.cs" Inherits="holidayslist" %>
...
<body>
  ...
  <div class="content">
   ...
   <h2 style="color:White;">List of Holiday Details</h2>
<br />
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="*" ControlToValidate="TextBox2" ValidationGroup="life"></asp:RequiredFieldValidator>
     ...
     <asp:TextBox ID="TextBox3" runat="server" Width="500px" Height="70px" placeholder="Festival" ValidationGroup="life" TextMode="MultiLine"></asp:TextBox>
