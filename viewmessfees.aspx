<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewmessfees.aspx.cs" Inherits="viewmessfees" %>
...
.form-style-8 input[type="submit"]:hover {
 ...
 <script language="javascript" type="text/javascript">
   function dele(id)
  {
   location.href='viewmessfees.aspx?id='+id;
  }
  </script>
</head>
<body>
  ...
  <div class="content">
   ...
   <h2 style="color:White;">View Mess Fees</h2>
 <asp:DropDownList ID="DropDownList4" runat="server" Width="500px" Height="50px" ValidationGroup="life" 
   ...
   <asp:DropDownList ID="DropDownList3" runat="server" Width="500px" Height="50px" ValidationGroup="life" 
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" ControlToValidate="DropDownList3" ValidationGroup="life"></asp:RequiredFieldValidator>
  ...
  <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
       ...
       PageSize="5" onselectedindexchanged="GridView1_SelectedIndexChanged1" 
            ...
            <RowStyle HorizontalAlign="Center" BackColor="White"/>
                ...
                <asp:BoundField DataField="messfees" HeaderText="Mess Fees"/>
