...
<body>
    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="studentleave.aspx"><span>Student Leave</span></a></li>
  ...
  <div class="content">
   ...
   <h2 style="color:White;">Student Leave Details</h2>
<br />
    ...
    <asp:TextBox ID="TextBox9" runat="server" Width="500px" Height="30px" placeholder="Leave From Date & Time" ValidationGroup="life"></asp:TextBox>
    ...
    <asp:TextBox ID="TextBox11" runat="server" Width="500px" Height="30px" placeholder="Leave To Date & Time" ValidationGroup="life"></asp:TextBox>
    ...
    <asp:TextBox ID="TextBox10" runat="server" Width="500px" Height="30px" placeholder="To- Place Name" ValidationGroup="life"></asp:TextBox>
    <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ErrorMessage="*" ControlToValidate="TextBox10" ValidationGroup="life"></asp:RequiredFieldValidator>
    
    <asp:TextBox ID="TextBox12" runat="server" Width="500px" Height="30px" placeholder="Leave Reason" ValidationGroup="life"></asp:TextBox>
    <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ErrorMessage="*" ControlToValidate="TextBox12" ValidationGroup="life"></asp:RequiredFieldValidator>
